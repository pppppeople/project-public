...
module.exports = {
  ...
  MEMORY_EVENTS_FILE: path.join(CLAUDE_HOME, 'wechat-memory-events.json'),
  DYNAMIC_MEMORY_FILE: path.join(CLAUDE_HOME, 'wechat-dynamic-memory.md'),
  MEMORY_REFRESH_STATE_FILE: path.join(CLAUDE_HOME, 'wechat-memory-refresh-state.json'),
